...
InterchangeLetters = Dict[str, List[str]]
...
def check(somestr: str, check: int = STRING, interchange: InterchangeLetters = ALL):
    """
    ...
    :keyword int check:
        It is mode of checking. Follows modes are available:
            ...
            - STRING - means that checking of string performs as string.
              See more at help(palindromus.checkstring)
            - WORD - means that checking of string performs as word.
              See more at help(palindromus.checkword)
            - MULTILINE - means that checking of string performs as multiline palindrome.
              See more at help(palindromus.checkmultiline)
            - TEXT - means that checking of string performs as text.
              See more at help(palindromus.checktext)
            - SUPER - means that checking of string performs as superpalindrome.
              See more at help(palindromus.checksuper)
...
def checkstring(somestr: str, interchange: InterchangeLetters = ALL):
    """
...
def checkword(someword: str, interchange: InterchangeLetters = ALL):
    """
...
def checkmultiline(sometext: str, interchange: InterchangeLetters = ALL):
    """
...
def checktext(sometext: str, interchange: InterchangeLetters = ALL):
    """
...
def checksuper(sometext: str, interchange: InterchangeLetters = ALL):
    """
...
def OnlyStringsCanBeChecked(somestr: str):
    """
